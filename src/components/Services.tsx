  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col h-full justify-between">
        ...
        {/* Bullets */}
        <div className="flex flex-wrap gap-2 pt-5 border-t border-zinc-800/60 light:border-zinc-200/60">
          {service.bullets.map((bullet, bIdx) => (
            <span
              key={bIdx}
              className="px-2.5 py-1 rounded-[0.5rem] border border-zinc-800 bg-zinc-900/40 text-zinc-400 text-[9px] font-bold uppercase tracking-wider group-hover:border-[#dc2626]/20 group-hover:bg-[#dc2626]/5 group-hover:text-[#dc2626] transition-all duration-300 light:border-zinc-200 light:bg-zinc-50 light:text-zinc-500"
            >
              {bullet}
            </span>
          ))}
