...
export function Footer() {
  return (
    <footer className="bg-transparent pt-16 md:pt-24 pb-8 px-4 md:px-6 border-t border-zinc-900 relative" id="contact">
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[80%] h-px bg-gradient-to-r from-transparent via-brand/50 to-transparent" />
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-24">
          <div>
            ...
            <h2 className="text-4xl sm:text-5xl md:text-7xl font-display font-bold text-white mb-6 leading-tight max-w-lg">
            ...
            <p className="text-lg text-zinc-400 leading-relaxed max-w-md mb-10">
              If your brand needs better content, stronger visuals, smarter digital execution, or a
              complete growth ready system, Brand Brick Studio is ready to build with you.
            </p>
          ...
          <div className="flex flex-col lg:items-end gap-14">
            ...
            <div className="flex flex-col gap-6 w-full max-w-lg lg:ml-auto">
              <a
                ...
                className="group relative flex items-center gap-4 md:gap-6 p-5 md:p-7 rounded-[2rem] bg-zinc-950/40 backdrop-blur-md border border-zinc-800/40 hover:border-brand/40 hover:bg-zinc-950/80 transition-all duration-300 overflow-hidden shadow-lg"
              >
                ...
                <div className="flex-grow min-w-0">
                  <span className="text-[10px] md:text-xs font-bold text-[#dc2626] uppercase tracking-[0.2em] block mb-1">
                    Direct Channel
                  </span>
                  <span className="text-sm md:text-lg lg:text-xl font-display font-bold text-zinc-300 block break-all group-hover:text-white transition-colors duration-300">
              ...
              <div className="group relative flex items-center gap-4 md:gap-6 p-5 md:p-7 rounded-[2rem] bg-zinc-950/40 backdrop-blur-md border border-zinc-800/40 hover:border-brand/40 hover:bg-zinc-950/80 transition-all duration-300 overflow-hidden shadow-lg">
                <div className="absolute inset-0 bg-gradient-to-r from-brand/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                <div className="relative w-12 h-12 rounded-2xl bg-zinc-900 border border-zinc-850 flex items-center justify-center shrink-0 group-hover:bg-brand/15 group-hover:border-brand/40 group-hover:shadow-[0_0_15px_rgba(220,38,38,0.2)] transition-all duration-300">
                ...
                <div className="flex-grow min-w-0">
                  ...
                  <span className="text-sm md:text-lg lg:text-xl font-display font-bold text-zinc-300 block break-words group-hover:text-white transition-colors duration-300">
                    Silvassa, India
                  </span>
                </div>
              </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 border-t border-zinc-900 pt-8">
          <div className="flex flex-wrap gap-x-8 gap-y-4">
            {links.map((link) => (
              <a key={link.name} href={link.href} className="text-sm font-medium text-zinc-500 hover:text-white transition-colors">
                {link.name}
              </a>
            ))}
          </div>
          <div className="text-left md:text-right">
            ...
            <p className="text-sm text-zinc-500 font-medium mt-1">
              Built to <span className="text-zinc-400">stand out.</span> Created for{" "}
